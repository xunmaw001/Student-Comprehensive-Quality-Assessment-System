	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input type="text" name="xuehao" placeholder="学号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="yuanxi" placeholder="院系" class="form-control-i">
							</div>
																								<div class="form-group">
							<label class="label">电话</label> 
							<input type="text" name="dianhua" placeholder="电话" class="form-control-i">
							</div>
																								<div class="form-group">
