		...
		<div class="login-container">
			...
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="name" name="name" placeholder="请输入试卷名称" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
					<label class="layui-form-label">考试时长(分钟)：</label>
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="time" name="time" placeholder="请输入考试时长(分钟)" autocomplete="off" class="layui-input">
					</div>
				</div>
